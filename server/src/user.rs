...
impl User {
    ...
    pub fn tick(&mut self, platforms: &[platform::Platform]) {
        ...
        let horizontal_collision: entity::HorizontalCollision = self.entity.horizontal_bounds_collision();
        let vertical_collision: entity::VerticalCollision = self.entity.vertical_bounds_collision();
